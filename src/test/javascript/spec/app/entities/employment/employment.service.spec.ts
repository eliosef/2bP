...
describe('Service Tests', () => {
    describe('Employment Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EmploymentService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Employment(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Employment', async () => {
            ...
            it('should return a list of Employment', async () => {
                const returnedFromService = Object.assign(
                    {
                        position: 'BBBBBB'
                    },
