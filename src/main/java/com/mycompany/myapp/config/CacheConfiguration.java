...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Employment.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Employment.class.getName() + ".employees", jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Employment.class.getName() + ".managers", jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Report.class.getName(), jcacheConfiguration);
